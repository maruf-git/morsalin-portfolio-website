/**
 * Honors & Awards Section — Minimalist
 */
          ...
          {honorsAwards.map((award, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-bold text-lg sm:text-xl text-text-primary leading-snug mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-accent group-hover:to-emerald-500 transition-all duration-300">
                  {award.title}
                </h3>
              ...
              <div className="pt-5 border-t border-border/60 mt-auto relative z-10">
                <p className="text-[13px] font-bold text-transparent bg-clip-text bg-linear-to-r from-text-secondary to-text-muted flex items-center gap-2 uppercase tracking-wide">
                  <span className="w-1.5 h-1.5 rounded-full bg-linear-to-r from-accent to-emerald-500" />
                  {award.issuer}
                </p>
              </div>
            </motion.div>
